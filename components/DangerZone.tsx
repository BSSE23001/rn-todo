...
const DangerZone = () => {
  ...
  const handleResetApp = async () => {
    Alert.alert(
        "Reset App",
        "This will delete all todos permanently. This actions cannot be undone.",
        [
            {text: "Cancel", style: "cancel"},
            {
                ...
                onPress: async () => {
                    try {
                        ...
                        Alert.alert("App Reset", `Successfully Deleted ${result.deletedCount} todos. Your App Has been RESET`)
                    } catch (e) {
    ...
    >
        ...
        >
            <View style={settingsStyles.actionLeft}>
                ...
                <Text style={settingsStyles.actionTextDanger}>Reset the App</Text>
            </View>
